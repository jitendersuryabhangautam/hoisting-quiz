...
console.log(obj.arrow());`,
  ...
  },
  {
    ...
    topic: "Functions",
    title: "default parameters and hoisting",
    prompt: "What is logged?",
...
console.log(foo());`,
    expected: "10",
    explanation:
      "DEFAULT PARAMETERS EVALUATION:\n1. Parameters are evaluated left-to-right\n2. a = b (b is undefined yet) → a = undefined\n3. b = 5\n4. Then a + b = undefined + 5 = NaN? Wait, actually:\n\nCORRECTION: Default parameters create TDZ for later parameters.\n1. a = b → b is in TDZ → ReferenceError\n\nWait, actually this throws ReferenceError because b is not yet initialized.\n\nEXECUTION PHASE:\n1. foo() called with no args\n2. a = b → b is in TDZ → ReferenceError\n\n📌 KEY: Default parameters have TDZ. Later parameters can't reference earlier ones.",
  },
  {
