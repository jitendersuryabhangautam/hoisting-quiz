...
test();`,
  ...
  },
  {
    ...
    expected: "A closure is a function that remembers the lexical scope where it was created.",
  ...
  },
  {
    ...
    prompt: "Write a function that merges two arrays without mutating either one.",
...
var x = 10;`,
  ...
  function inner() {
    ...
    takeaway: "Lexical scope is decided by where code is written, not where it runs.",
  },
  {
    title: "Closures",
  ...
  },
  {
    ...
    takeaway: "Favor new values over in-place mutation unless performance demands otherwise.",
  },
  {
    title: "Prototype",
...
await Promise.allSettled([taskA(), taskB()]);`,
    takeaway: "Use all for all-or-nothing work, allSettled for reporting every result.",
  },
  {
    title: "Immutability",
    ...
    takeaway: "Small pure helpers are easier to test than shared mutable state.",
  },
];
